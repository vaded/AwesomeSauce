...
/********Begin of IngredientList Model*********/
  ...
  var IngredientList = Parse.Collection.extend({
    ...
    // Filter down the list of all Ingredient items that are finished.
    status: function() {
...
//was #manage-todos-template
    ...
    filter: function() {
      ...
      this.$("ul#filters-i a").removeClass("selected");
      this.$("ul#filters-i a#" + filterValue).addClass("selected");
      if (filterValue === "all") {
        this.addAll();
    ...
    resetFilters: function() {
      this.$("ul#filters-i a").removeClass("selected");
      this.$("ul#filters-i a#all").addClass("selected");
      this.addAll();
    },
